;(function(){
	$.fn.Paging = function(obj,listCount,currentPage){
		var page = {
			"pageId":"",
		    "data":null,
		...
		page = $.extend(true,page,obj);
		page.init=function(listCount,currentPage,options){
		    ...
		    this.initPage(listCount,currentPage);
		};
		  ...
		  /**
		     ...
		     */
		page.initPage=function(listCount,currentPage){
		     ...
		     * @param listCount 列表总量
		     */
		    page.initWithUl=function(listCount,currentPage){
		        var pageCount = 1;
		        if(listCount>=0){
		     ...
		     */
		    page.setPageListCount=function(listCount,currentPage){
		    ...
		    //页面显示功能
		     page.viewPage=function(currentPage,listCount,pagelistcount,data){
		    ...
		    page.initPageEvent=function(listCount){
		        $("#"+page.pageId +">li[class='pageItem']").on("click",function(){
		            page.setPageListCount(listCount,$(this).attr("page-data"),page.fun);
		        });
		    };
		    page.getPageListModel=function(pageCount,currentPage){
		    ...
		    page.init(listCount,currentPage,obj);
		}
